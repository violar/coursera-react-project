...
class Contact extends Component{
    ...
    handleInputChange(event){
        ...
        // depending on target type, it will be handled differently
        // if target type is a checkbox retrieve value of checked else retrieve from regular value property
